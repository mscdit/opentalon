...
func (s *blockingSetSummaryStore) Create(id, entityID, groupID, kind, systemSource string) *state.Session {
	return s.inner.Create(id, entityID, groupID, kind, systemSource)
}
